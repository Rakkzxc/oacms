                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <datalist id="doctors">
                            ...
                            while ($row = $list11->fetch_assoc()) {
                                echo "
                                <option value='$row[docname]'></option><br/>
                                <option value='$row[docemail]'></option><br/>";
                            }
                            ?>
                        </datalist>
                                    ...
                                    <div class="abc">
                                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                            ...
                                            <form action="edit-doc.php" method="POST" class="add-new-form">
                                                <tr><td><p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Doctor Details.</p>Doctor ID : '.$id.' (Auto Generated)<br><br></td></tr>
                                                <tr><td class="label-td" colspan="2"><label for="Email" class="form-label">Email: </label><input type="hidden" value="'.$id.'" name="id00"><input type="hidden" name="oldemail" value="'.$email.'" ></td></tr>
