...
<body>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    ...
                    <td><button id="export-btn" class="btn-primary-soft btn" onclick="exportToExcel()" style="padding: 15px; margin :0;width:100%">Export</button></td>
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop, schedule.schedule_fee from schedule inner join doctor on schedule.docid=doctor.docid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop, schedule.schedule_fee from schedule inner join doctor on schedule.docid=doctor.docid  order by schedule.scheduledate desc";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="schedule_fee" class="form-label">Session Fee: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="schedule_fee" class="input-text" placeholder="Fee" required><br>
                                </td>
                            </tr>
    ...
    const fileName = 'schedule_data.xls';
