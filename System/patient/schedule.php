                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <div style='width:100%'>
                                            <div class='h1-search'><input type='checkbox' name='$counter' value='$scheduleid' class='custom-checkbox' onchange='updateTotal()'>
                                            ".substr($title,0,21)."
                                            </div><br>
                                            <div class='h3-search'>
                                            ".substr($docname,0,30)."
                                            ...
                                            <div class='h3-search'>
                                                Fee: P<span>".$schedule_fee. "</span>
                                                <input type='hidden' value='$schedule_fee' class='schedule_fee'>
                                            </div>
                                            <div class='h4-search'>Date:
...
<script>
    function updateTotal() {
        ...
        var fees = document.querySelectorAll('.schedule_fee');

        var total = 0;

        checkboxes.forEach(function(checkbox, index) {
            if (checkbox.checked) {
                total += parseInt(fees[index].value);
            }
        });
