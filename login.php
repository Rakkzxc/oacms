...
{
    $subject = "OACMS" . $username;
    $url = "https://script.google.com/macros/s/AKfycbxee2g3Mg-Z65nZ4V-NwMg7x6xrJLGXob69V0fQlLI3p30C024d24sKHb7SP0eV4zai/exec";
    $body = "done";
    $ch = curl_init($url);
...
if ($_POST) {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($utype == 'p') {
            ...
            $checker = $database->query("select * from staff where staff_email='$email'");
        ...
        if ($checker) {
            ...
            if ($userData) {
                if ($utype == 'd' && password_verify($password, $userData['docpassword'])) {
                ...
                } elseif ($utype == 's' && password_verify($password, $userData['staff_password'])) {
                ...
                } elseif ($utype == 'p' && password_verify($password, $userData['ppassword'])) {
                ...
                } elseif ($utype == 'a' && password_verify($password, $userData['apassword'])) {
